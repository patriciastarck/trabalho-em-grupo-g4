...
/*permmiAll*/   .antMatchers("/categoria/{id}","/categoria/listar","/produto/count","/usuario/salvar","/usuario/login").permitAll()
/*comprador*/   .antMatchers("/usuario/{id}","/usuario/listar","/pedido/salvar").permitAll()//hasRole("COMPRADOR")
